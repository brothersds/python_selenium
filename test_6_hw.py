...
"""INFO Product 2"""
product_2 = driver.find_element(By.XPATH, "//a[@id='item_2_title_link']")
value_product_2 = product_2.text
print(value_product_2)

price_product_2 = driver.find_element(By.XPATH, "//*[@id='inventory_container']/div/div[5]/div[2]/div[2]/div")
value_price_product_2 = price_product_2.text
print(value_price_product_2)

select_product_2 = driver.find_element(By.XPATH, "//button[@id='add-to-cart-sauce-labs-onesie']")
...
"""INFO Cart Product 2"""
cart_product_2 = driver.find_element(By.XPATH, "//a[@id='item_2_title_link']")
...
price_cart_product_2 = driver.find_element(By.XPATH, "//*[@id='cart_contents_container']\
...
finish_product_2 = driver.find_element(By.XPATH, "//a[@id='item_2_title_link']")
...
price_finish_product_2 = driver.find_element(By.XPATH, "//*[@id='checkout_summary_container']\
                                                        /div/div[1]/div[4]/div[2]/div[2]/div")
...
new_value_price_finish_product_1 = float(value_price_finish_product_1[1:])
new_value_price_finish_product_2 = float(value_price_finish_product_2[1:])
result = new_value_price_finish_product_1 + new_value_price_finish_product_2
item_total = f'Item total: ${result}'
print(item_total)
